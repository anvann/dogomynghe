...
?>
    ...
    <section>
        <div class="pageintro">
            <div class="pageintro-bg">
                <img src="style\images\page.png" alt="About Us">
            </div>
    ...
    <!-- Product Detail -->
    <section>
        <div class="container p-b-90 p-t-30">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="main-wrap-pic">
                                    <div class="main-frame">
                                        <div class="wrap-main-pic">
                                            <div class="main-pic">
                                                <img style="width: 80%" src="admin/uploads/products/<?php echo $product['image']; ?>"  alt="image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
